...
func (s *Server) Init() error {
	s.router.Get("/offers.getAll", s.handleGetOffers)
	s.router.Get("/offers.getById", s.handleGetOfferByID)
	s.router.Post("/offers.save", s.handleSaveOffer)
	s.router.Delete("/offers.removeById", s.handleRemoveOfferByID)
